...
import {
    ...
    Package, DollarSign, Layers, Info, Settings, Star, Loader2
} from 'lucide-react';
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500">Fill all details to add product to your store</p>
                    </div>
                </div>
                <button
                    onClick={handleSubmit}
                    disabled={saving || !form.name || form.base_price <= 0}
                    className="flex items-center gap-2 px-6 py-2 bg-[#2874f0] text-white rounded-lg font-bold hover:bg-blue-600 transition disabled:opacity-50 shadow-sm"
                >
            ...
            <div className="flex gap-2 overflow-x-auto pb-2 border-b border-gray-200">
                {tabs.map(tab => (
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg whitespace-nowrap transition text-sm font-medium ${activeTab === tab.id
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-6 space-y-6 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="md:col-span-2">
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none text-lg transition-all"
                                    required
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    <input
                                        ...
                                        placeholder="Add tag..."
                                        className="flex-1 px-4 py-3 bg-white border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all"
                                        onKeyDown={(e) => e.key === 'Enter' && (e.preventDefault(), addTag())}
                                    />
                                    <button type="button" onClick={addTag} className="px-4 py-3 bg-gray-100 rounded-lg hover:bg-gray-200 text-gray-600 transition-colors">
                                ...
                                {form.tags.length > 0 && (
                                    <div className="flex flex-wrap gap-2 mt-3">
                                        {form.tags.map(tag => (
                                            <span key={tag} className="flex items-center gap-1 px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-sm border border-blue-100">
                                                {tag}
                        ...
                        <div className="flex flex-wrap gap-6 pt-6 border-t border-gray-100">
                            <label className="flex items-center gap-3 cursor-pointer group">
                                ...
                                />
                                <div>
                                    <span className="font-medium text-gray-900 group-hover:text-blue-600 transition-colors">Active</span>
                            ...
                            <label className="flex items-center gap-3 cursor-pointer group">
                                ...
                                />
                                <div>
                                    <span className="font-medium text-gray-900 group-hover:text-blue-600 transition-colors">Featured</span>
                            ...
                            <label className="flex items-center gap-3 cursor-pointer group">
                                ...
                                />
                                <div>
                                    <span className="font-medium text-gray-900 group-hover:text-blue-600 transition-colors">New Arrival</span>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="1499"
                                    className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none text-lg font-bold text-gray-900 transition-all"
                                    required
                                    min="1"
                                />
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1.5">Compare/MRP Price (₹)</label>
                                <input
                                    type="number"
                        ...
                        {form.compare_price > form.base_price && form.base_price > 0 && (
                            <div className="flex items-center gap-4 p-4 bg-green-50 border border-green-100 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-green-600">Customer saves ₹{(form.compare_price - form.base_price).toLocaleString()}</p>
                                </div>
                            </div>
                        )}
                ...
                {activeTab === 'images' && (
                    <div className="bg-white border border-gray-200 rounded-xl p-6 space-y-6 shadow-sm">
                        ...
                        <p className="text-sm text-gray-500">First image will be the main product image. Drag to reorder.</p>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            {form.images.map((img, i) => (
                                <div key={i} className="relative aspect-square bg-gray-100 rounded-xl overflow-hidden group border border-gray-200">
                                    ...
                                    <button
                                        ...
                                        className="absolute top-2 right-2 p-2 bg-red-500 text-white rounded-full opacity-0 group-hover:opacity-100 transition shadow-sm"
                                    >
                                        <Trash2 className="w-4 h-4" />
                                    </button>
                                    {i === 0 && (
                                        <span className="absolute bottom-2 left-2 px-2 py-1 bg-blue-600 text-white text-xs rounded-full font-bold shadow-sm">
                                            MAIN
                                        </span>
                                    )}
                                </div>
                            ...
                            <div className="aspect-square bg-gray-50 border-2 border-dashed border-gray-300 rounded-xl flex flex-col items-center justify-center text-center p-4">
                        ...
                        <div className="flex gap-2">
                            ...
                            <button
                                type="button"
                                onClick={addImage}
                                className="px-6 py-3 bg-blue-50 text-blue-600 border border-blue-100 rounded-lg font-medium hover:bg-blue-100 transition-colors"
                            >
                                <Plus className="w-5 h-5" />
                            </button>
                        </div>
                        ...
                        <div className="p-4 bg-blue-50 border border-blue-100 rounded-lg">
                            <p className="text-blue-700 text-sm">💡 Use high-quality images (1000x1000px recommended). You can use images from Unsplash, your hosting, or any public URL.</p>
                        </div>
                    </div>
                )}
                ...
                {activeTab === 'variants' && (
                    <div className="bg-white border border-gray-200 rounded-xl p-6 space-y-6 shadow-sm">
                        ...
                        <p className="text-sm text-gray-500">Add options like Color, Size, Storage, etc.</p>
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="flex flex-wrap gap-2 mt-2">
                                                {variant.options.map((opt, j) => (
                                                    <span key={j} className="px-3 py-1 bg-white border border-gray-200 rounded-full text-sm text-gray-600">{opt}</span>
                                                ))}
                                            </div>
                                        </div>
                                        <button
                ...
                {activeTab === 'seo' && (
                    <div className="bg-white border border-gray-200 rounded-xl p-6 space-y-6 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1.5">Default Rating (1-5)</label>
                                <input
                                    type="number"
                                    value={form.rating}
                ...
                <div className="flex gap-4 pt-4">
                    <button
                        type="submit"
                        disabled={saving || !form.name || form.base_price <= 0}
                        className="flex-1 flex items-center justify-center gap-2 py-4 bg-[#2874f0] text-white rounded-xl font-bold text-lg hover:bg-blue-600 transition disabled:opacity-50 shadow-lg shadow-blue-500/20"
                    >
